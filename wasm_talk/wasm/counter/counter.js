...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'counter.wast';
  var wasmBinaryFile = 'counter.wasm';
  var asmjsCodeFile = 'counter.temp.asm.js';
...
var real__set_count = asm["_set_count"]; asm["_set_count"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__set_count.apply(null, arguments);
};
...
var _set_count = Module["_set_count"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_set_count"].apply(null, arguments) };
